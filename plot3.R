...
plot(household$Sub_metering_1,type = 'l',col = "black",xaxt="n",ylab = "Energy sub metering",xlab = " ")
lines(household$Sub_metering_2,type = 'l',col = "red",xaxt="n")
lines(household$Sub_metering_3,type = 'l',col = "blue",xaxt="n")
